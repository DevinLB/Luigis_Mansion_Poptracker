...
starting_room_strings = {
    ["Hidden Room"] = "hidden",
    ["Courtyard"] = "courtyard",
    ["Clockwork Room"] = "clockwork",
    ["Foyer"] = "foyer",
    ["Rec Room"] = "rec_room",
    ["Laundry Room"] = "laundry",
    ["Telephone Room"] = "telephone",
    ["Butler's Room"] = "butler",
    ...
    ["1F Bathroom"] = "bathroom_1f",
    ["Mirror Room"] = "mirror",
    ["Ballroom"] = "ballroom",
    ["Storage Room"] = "storage",
    ["Breaker Room"] = "breaker",
    ["Dining Room"] = "dining",
    ["Armory"] = "armory",
    ["Pipe Room"] = "pipe",
    ["Cold Storage"] = "cold",
    ["Secret Altar"] = "secret_altar",
}